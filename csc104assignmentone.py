...
'''
name = 'Mohammed Sani Busu'
department = 'Computer Scsccience'
...
sani_score = 5
musa_score = 6
total_scores = sani_score + musa_score
...
'''
sum_of_two_numbers = 5 + 5
print(sum_of_two_numbers)

''' write the code that find a remainder when 8 is divided by 3
'''
first_number = 8
second_number = 3
...
''' Rewrite the following statment to force this orders first, multiply 2 by 4. then add 4 and 2
	then multiply the first result by second result print the result.
	x = 2*4*4+2
'''
first_result = 2*4
second_result = 4+2
first_and_second_results = first_result * second_result
print(first_and_second_results) 
